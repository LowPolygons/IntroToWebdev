const album_songs = {
  "codename-x": {
    ...
    songs: [
      { name: "Codename X", run_time: "3:21" },
      { name: "Float Away", run_time: "4:02" },
      { name: "Shadowflame", run_time: "4:00" },
      { name: "Robo Kitty", run_time: "4:10" },
      { name: "Bring the Madness", run_time: "3:25" },
      { name: "Interstellar", run_time: "4:03" },
      { name: "Live Wire", run_time: "4:12" },
      { name: "Out of Time", run_time: "3:49" },
      { name: "X Up", run_time: "4:03" },
      { name: "Push It Up", run_time: "3:50" },
      { name: "Night Shine", run_time: "4:21" }
    ]
  },
  "onyx": {
    album_name: "Onyx",
  ...
  "apex": {
    album_name: "Apex",
    songs: [
      { name: "Exterminate", run_time: "3:34" },
      { name: "1 On 1", run_time: "3:19" },
      { name: "Wake Up", run_time: "5:39" },
      { name: "Tonight", run_time: "4:31" },
      { name: "Gold (Stupid Love)", run_time: "4:55" },
      { name: "Fall", run_time: "3:56" },
      { name: "Home", run_time: "3:57" },
      { name: "Where Are You", run_time: "3:05" },
      { name: "Power", run_time: "4:02" },
      { name: "Vault", run_time: "4:57" },
      { name: "Die For You", run_time: "3:59" },
      { name: "Hoods Up", run_time: "4:00" },
      { name: "Fight Through The Pain", run_time: "4:11" },
      { name: "Rumble", run_time: "4:42" }
    ]
  }
};
